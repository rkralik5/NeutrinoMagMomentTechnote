...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.3\linewidth]{Plots/FeynmanDiagramNuElmagInt.png}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.45\linewidth]{Plots/NuoneInteraction.png}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=.7\textwidth]{Plots/dSdTNumuMMCompAltLim.pdf}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=.7\textwidth]{Plots/RatioNumuMMCompLinX.pdf}
